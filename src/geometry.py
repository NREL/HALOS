...
class Receiver:
    def __init__(self, shape_type, tow_height, params,solar_field= None):
        """
                ...
                center_loc: x,y,z coordinates of center
...
class FlatPlateReceiver(Receiver):
    def __init__(self, tow_height, params):
        ...
        try:
            ...
            pass
        self.dni = params.get('flux_dni')
        #self.generateFixedFluxLimits(0,params["power_rating"]/sum(self.surface_area))


    def getSurfaceArea(self):
        """This is for the flat plate only; needs to be generalized"""
        ...
        #print("Surface Area - Geometry line 162: ", self.surface_area)
...
class CylindricalPlateReceiver(Receiver):
    ...
    def getSectionFluxColumn(self,section_id):
        self.section_flux = [
